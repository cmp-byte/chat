...
public class Message implements IMessage,Utils,Comparable<Message>{
    ...
    public boolean send() {
        ...
        try {
            ...
            String sql = "INSERT INTO messages(id_user,id_group,content_text,attachment) VALUES(?,?,?,?)";
            ...
            try {
                ...
                ResultSet rs = stmp.executeQuery("SELECT * from  messages where id_message=LAST_INSERT_ID()");
                rs.first();
    ...
    public boolean edit(String newContent) {
        ...
        try {
            con= DriverManager.getConnection(connectionString,user,password);
            String sql = "UPDATE  messages SET content_text=? WHERE id_message = ?";
            PreparedStatement pstmt = con.prepareStatement(sql);
